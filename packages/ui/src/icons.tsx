...
const PATHS: Record<string, string[]> = {
  ...
  user: [
    'M18 20v-1.5A4.5 4.5 0 0 0 13.5 14h-3A4.5 4.5 0 0 0 6 18.5V20',
  ...
  fuel: [
    'M4 20V6a2 2 0 0 1 2-2h5a2 2 0 0 1 2 2v14',
    'M3 20h11M13 9h3a2 2 0 0 1 2 2v5a1.5 1.5 0 0 0 3 0V9l-2.5-3M7 8h3',
  ],
  settings: [
  ...
  building: [
    ...
    'M15 9h3a2 2 0 0 1 2 2v10M3 21h18M8 7h3M8 11h3M8 15h3',
  ],
  phone: [
    'M15.5 21A13.5 13.5 0 0 1 3 8.5V6a2 2 0 0 1 2-2h2l1.5 4-2 1.5a10 10 0 0 0 4.5 4.5L12.5 12l4 1.5V16a2 2 0 0 1-2 2h-.5',
  ],
